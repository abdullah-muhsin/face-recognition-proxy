...
| Network | Wired interface `1`, Wi-Fi interface `2`, Wi-Fi status, access-point scan, and SSH state are readable. Interface `2` reports the observed reachable IP `192.168.1.3`. |

...
| Network | Wired interface `1`, Wi-Fi interface `2`, Wi-Fi status, access-point scan, SSH state/control, and exposed TCP services are documented. Interface `2` reports the observed reachable IP `192.168.1.200`. |
